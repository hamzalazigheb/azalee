        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-gradient-to-br from-[#253F60]/10 to-[#B99066]/10 rounded-xl p-8 border-l-4 border-[#253F60] mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-[#253F60] font-semibold text-lg">FR001400ZAJ8</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 mb-1">Thématique</p>
                  <p className="text-[#253F60] font-semibold text-lg">Intelligence artificielle & robotique</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-[#253F60] font-semibold text-lg">iEdge Global Artificial Intelligence & Robotics EW Decrement 50 Points GTR®</p>
                </div>
                <div>
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-500">
                <h3 className="text-[#253F60] font-bold text-lg mb-3 flex items-center gap-2">
                  <span className="text-green-500">✓</span> Diversification sectorielle
                </h3>
                <p className="text-[#4B5563]">
          ...
          <div className="mb-12">
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 rounded-xl p-8">
              <div className="space-y-4">
                ...
                <div>
                  <h3 className="text-[#253F60] font-bold text-lg mb-2">⚠️ Volatilité accrue des marchés technologiques</h3>
                  <p className="text-[#4B5563]">

        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    ...
                    <p className="text-white font-semibold text-lg">FR001400ZAJ7</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                    <p className="text-white/80 text-sm mb-2">Thématique</p>
                    <p className="text-white font-semibold text-lg">Luxe & consommation mondiale</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
                  ...
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20 md:col-span-2">
                    ...
                    <p className="text-white font-semibold text-lg">iEdge Transatlantic Luxury Goods & Services 10 EW Decrement 50 Points GTR®</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4 border border-white/20">
          ...
          <div className="mb-16">
            <SectionHeader 
              ...
              subtitle="Une opportunité d'investissement dans le secteur du luxe"
            />

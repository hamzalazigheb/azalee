...
export default function AutreRetraiteCMSPage() {
  ...
  useEffect(() => {
    async function fetchContent() {
      try {
        const res = await fetch('/api/cms/content?path=retraite/autre', {
          cache: 'no-store',
          headers: {
  ...
  const { hero, solutions, objectif, cta } = content;
        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h1 className="text-white text-3xl sm:text-4xl lg:text-5xl font-cairo font-semibold leading-tight mb-6">
              {hero?.title || "Autres solutions retraite"}
            </h1>
        ...
        <div className="max-w-[1368px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-cairo font-bold text-[#253F60] mb-4">
              {solutions?.title || "Solutions complémentaires"}
            </h2>

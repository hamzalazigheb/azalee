            ...
            {menuOpen && (
              <div className="lg:hidden w-full border-b border-white/20 pb-4 mb-4">
                ...
                <div className="space-y-3">
                  {topBar.contact?.phone && (
                    <a 
                      href={topBar.contact.phone.link || `tel:${topBar.contact.phone.number.replace(/\s/g, '')}`}
                      className="flex items-center gap-3 text-white hover:text-[#B99066] transition-colors"
                    >
                      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                      </svg>
                      <span className="text-base font-medium">{topBar.contact.phone.number}</span>
                    </a>
                  )}
                  {topBar.contact?.email && (
                    <a 
                    ...
                    >
                      ...
                      <span className="text-base font-medium">{topBar.contact.email.address}</span>
                    </a>
                  )}
                  {topBar.social?.linkedin && (
                    <div className="pt-2 border-t border-white/20">
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 text-white hover:text-[#B99066] transition-colors"
                        aria-label="LinkedIn Azalée Patrimoine"
                      >
